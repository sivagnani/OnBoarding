                                ...
                                <div id="divManualSitePermission" className='row mb-4 p-2'>
                                    ...
                                    <div className="col-xs-11 col-sm-9 col-md-8">
                                        ...
                                        <div className="row mt-2">
                                            ...
                                            <div className="col-2 align-center pt-4 px-1c">
                                        ...
                                        { this.state.accessSites.length!==0 &&
                                            <div className="row">
                                                <caption className=".text-muted">Access For</caption>
                                            </div>
                                        }
                                        ...
                                        {this.state.accessSites.map((site) => 
                                            <tr className="align-items-center div-AccessFor bt-1">
                                                <td className="m-0 pl-1">{site.Title}</td>
                                                <td className="m-0">{site.Permission}</td>
                                                <td className="m-0"><Icon iconName="Clear" onClick={()=>this.deleteAccessSite(site.Id)} className="cursor-pointer pt-1" /></td>
                                            </tr>
                                        )}
                                        </tbody>
                                        </table>
